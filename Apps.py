...
if uploaded_file is not None:
    ...
    if len(equations) >= 4:
        a1, b1 = equations[0], equations[1]
        a2, b2 = equations[2], equations[3]
        st.text_input("Stützvektor 1. Gerade (aus Bild erkannt)", a1)
        st.text_input("Richtungsvektor 1. Gerade (aus Bild erkannt)", b1)
        st.text_input("Stützvektor 2. Gerade (aus Bild erkannt)", a2)
        st.text_input("Richtungsvektor 2. Gerade (aus Bild erkannt)", b2)
